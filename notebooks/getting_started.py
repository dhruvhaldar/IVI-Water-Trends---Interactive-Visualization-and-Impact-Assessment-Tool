...
def main():
    ...
    # Summary report
    summary_report = export_utils.generate_summary_report(
        merged_df, filename="demo_summary"
    )
    print(f"Summary report: {summary_report}")

    # Short summary
    short_summary = export_utils.generate_short_summary(
        merged_df, filename="demo_short"
    )
